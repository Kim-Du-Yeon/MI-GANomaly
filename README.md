...
### Loss Ablation AUC 곡선 (WandB)
![Loss Ablation AUC](output/MI-GANomaly.png)
...
### Optuna Bayesian Optimization (20 trials)
![Optuna AUC](output/MI-GANomaly-optuna.png)

### Multi-scale Masking 실험
![Masking AUC](output/MI-GANomaly-masking.png)
